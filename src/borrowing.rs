...
//             blood_pressure_change: self.last_blood_pressure.map(|(last_sys, last_dia)| {
//                 let (sys, dia) = measurements.blood_pressure;
//                 (last_sys as i32 - sys as i32, last_dia as i32 - dia as i32)
//             }),
//         }
//     }
// }
